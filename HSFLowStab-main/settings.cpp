...
task::TTaskParamsCalcScalProd g_taskParamsCalcScalProd;
...
bool load_Settings_n_Plugins()
{
	...
	task::TaskNames[task::RetraceStreamlines] = _T("RetraceStreamlines");

	task::TaskNames[task::GetWallGridLine] = _T("GetWallGridLine");
	...
	task::TaskNames[task::Test] = _T("Test");
	...
	// CalcScalProdDns section
	{
		conf->SetPath(_T("/CalcScalProd"));
