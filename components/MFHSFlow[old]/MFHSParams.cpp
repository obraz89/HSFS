...
void mf::t_MFHSFLOW2D::default_settings(){

	TPlugin::default_settings();

	TPluginParamsGroup g;

	_hsflow_default_settings(g);
...
void t_MFHSFLOW2D::init(const wxString& settingsFN, const wxString& spec){
	...
	_init_fld_base_params(_base_params, g);
...
void mf::t_MFHSFLOW3D::default_settings(){
...
void t_MFHSFLOW3D::init(const wxString& settingsFN, const wxString& spec){
...
void mf::_hsflow_default_settings(TPluginParamsGroup& g){
	...
	g.add("Mach", 1, _("Free stream Mach number")); // pMach
...
void mf::_init_fld_base_params(t_FldParams& params, const TPluginParamsGroup& g){
	...
	params.ViscType = g.get_real_param("ViscType");
