...
t_WPLineMax::t_WPLineMax(const t_MeanFlow& a_fld, t_StabSolver& a_stab_solver, t_EigenGS& a_gs_solver)
:t_WavePackLine(a_fld, a_stab_solver, a_gs_solver){}

void t_WPLineMax::retrace(t_Index start_from, t_WCharsLoc init_wave){
	/*
	// first stab entry
